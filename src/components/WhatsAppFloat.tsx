  ...
  return (
    <div className="fixed bottom-4 right-4 z-[1200] flex flex-col items-end pointer-events-none md:bottom-8 md:right-8">
      <button
        ...
        className="pointer-events-auto flex items-center gap-2 bg-herb-green text-white rounded-full px-4 py-3 md:px-6 md:py-4 font-semibold text-base md:text-lg shadow-lg hover:bg-herb-green/90 hover:scale-105 transition-transform"
