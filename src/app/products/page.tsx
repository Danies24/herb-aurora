    ...
    <div className="min-h-screen bg-herb-cream pt-28">
      <div className="max-w-[110rem] mx-auto px-4">
        ...
        {searchQuery && products.length === 0 ? (
          ...
          /* Product Grid */
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4 justify-items-center px-1 lg:px-16 pb-16 ">
            {products.map((product) => {
              ...
              return (
                ...
                >
                  {/* Image */}
                  <div className="relative w-full lg:h-58 h-36">
                    <img
                  ...
                  {/* Details */}
                  <div className="lg:p-4 p-2 flex flex-col flex-grow">
                    {product.rank === 2 ? (
                      <p className="text-xs text-herb-green font-semibold mb-1">
                        #{product.rank} IN {product.category.toUpperCase()}
                      </p>
                    ) : null}
                    <h2 className="lg:text-l text-sm text-herb-green font-semibold mb-1">
                      {product.name}
                    </h2>
